  ...
  return sendOnce({
    ...
    payload: {
      ...
      content: [
        ...
        pingLine,
        // Dwa różne linki celowo: strona eventu (opis, notatki, baner) i
        // zawsze aktualna rozpiska na żywo (wykres Gantta, samoodświeżająca
        // się, dostępna bez logowania) — patrz też pole embeda "ROZPISKA
        // ONLINE" w buildScheduleEmbeds (lib/discord.js).
        url ? `Strona wydarzenia: ${url}` : null,
        liveUrl ? `Rozpiska na żywo: ${liveUrl}` : null,
      ]
        .filter(Boolean)
        .join('\n'),
